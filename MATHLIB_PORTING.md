...
| `RobinBV.Mathlib.Analysis.SpecificLimits.IntervalMean` | `Mathlib/Analysis/SpecificLimits/IntervalMean.lean` | project-verified | Actual continuous and logarithmic floor means with derived local integrability; exact conjugation/centering, mean-to-variance transfer, and nonnegative real part of actual squared means and their limits |
...
| `RobinBV.Mathlib.Analysis.Complex.ShiftedInverseSquare` | `Mathlib/Analysis/Complex/ShiftedInverseSquare.lean` | project-verified | Full critical-line shifted inverse-square masses and Cauchy-Schwarz bounds; positive-weight countability and exact diagonal squared-coefficient mass a/(a-1)*(Z-M_a) for every real a>1 |
